...
FJSC_Total.RedFlag <- sum(Daily_High$value >= Hazardous_Days_Limits$Temp_Limit_Min_C[4] & Daily_High$value < Hazardous_Days_Limits$Temp_Limit_Min_C[5])
FJSC_Total.YellowFlag <- sum(Daily_High$value >= Hazardous_Days_Limits$Temp_Limit_Min_C[3] & Daily_High$value < Hazardous_Days_Limits$Temp_Limit_Min_C[4])
FJSC_Total.GreenFlag <- sum(Daily_High$value >= Hazardous_Days_Limits$Temp_Limit_Min_C[2] & Daily_High$value < Hazardous_Days_Limits$Temp_Limit_Min_C[3])
FJSC_Total.NoFlag <- sum(Daily_High$value < Hazardous_Days_Limits$Temp_Limit_Min_C[2])

...
Four datasets were obtained from the US Air Force 14th Weather Squadron, which collects "authoritative climate data" for the military. Each data set contains observations from a weather gauge on or near one of four army basic training installations (Table 1).
...
From a heat injury risk standpoint, Ft Benning is clearly the basic training installation at greatest risk of high heat days. Soldiers at Ft Benning would be expected to be at higher risk of heat related injury, something that has been found in studies exploring the incidents of per-capita heat illness at training installations (Defense Health Agency, 2022; Defense Health Agency, 2019).

\newpage

# Summary and Conclusions
#### High Temperature Trend Conclusion
The initial hypothesis proposed a significant increase in high temperatures and wet bulb globe temperatures over the observation period. The results of the analysis show there has not been a significant trend in higher temperatures between 2012 and 2022. There was an observable upward trend line, indicating some increase in high temperatures for each location. However, the time series analysis for both seasonal and seasonally corrected Mann Kendall tests shows that this upward trend is not statistically significant for most installations. The only temperature change p-value that was below .05 was Fort Benning. Based on current climate change trends, we expected to see a greater number of high temperature days for each location in the later years of the time frame analyzed. One possible explanation for this result is that temperatures have been consistently higher over the last ten years. If we performed the Mann Kendall test on data from 2002-2022 or 1992-2022, we might observe a different result.

#### WBGT Trend Conclusion
Prior to analysis, we also hypothesized that there would be an observable increase in wet bulb temperatures over the analysis period. The results of the Mann Kendall test run for the full year (January -- December) indicated a statistically significant positive trend for all locations except Fort Leonard Wood. However, the time series analysis for just the warmest months of the year (April -- September) only resulted in significant p-values for Fort Jackson and Fort Sill. The variation between the time series analysis indicates that higher temperatures from cooler months influenced the results and contribute to an overall increased WBGT more than temperatures in warmer months. Although the significant trend of greater WBGT throughout the entire year is an interesting result, our primary research question focused on whether there was a significant trend in warmer WBGT increases that could negatively impact human health.

The significant change for wet bulb temperatures compared to the insignificant results of the temperature trend is an especially interesting result. Wet bulb temperature values account for humidity, solar intensity, and wind. The significant values for wet bulb temperature indicates climate conditions apart from just temperature are changing over time. To deduce what climate conditions are influencing the change in wet bulb temperature, we would need data on the climate conditions for the same analysis period and run a similar time series analysis. Statistical analysis considering the correlation between other climate conditions and wet bulb temperature could also be performed. The combination of correlated values and time series analysis for other climate conditions may explain the variation between temperature and wet bulb globe temperature trends. The variation in WBGT results also implies climate change conditions are occurring at different rates across the United States. As a further additional research method, we could expand the scope of the study to include multiple weather gauge sites around each installation.

#### Black and Red Flag Day Conclusion
A small positive correlation was found between the number of Black or Red flag days during warm seasons month (April through September) at three of the installations, but this trend was not statistically significant. This leads to a conclusions of no clear trend to the number of Black or Red flag days during the 10 year period considered in this study. Possible reasons for this outcome include limitations with the study data set, which covered only ten years, and the choice to analyze Black and Red flag days during the period of April to September instead of the entire year. Given the gradual progression of climate change (at least compared to the 10 year time period used), a study using data with a longer time frame may have found more statistically significant conclusion.

Although no trend was unequivocally determined, a plot of high temperatures days provides an interesting analysis of how high temperature days compare between years and between training installations. Among training installations, Ft Benning, GA had the greatest number of high temperature days, while Ft Sill and Ft Jackson had a similar number. Understanding the historical number of days Red and Black flag can help planners determine the number of extra days that may need to be planned for a summer training cycle or the additional risk that activities during these time periods will incur. 

...
Derived Wet Bulb Globe Temperature (F). Wet Bulb Globe Temperature (WBGT) 
is a method of measuring temperature that considers environmental 
conditions affecting the human body's ability to
thermo-regulate and accounts for the ability to remove excess
heat through sweat. It is a temperature measurement used extensively
in the military to assess the risk of outdoor activity.
...
Publicly releasable versions of shapefile data for military installations
...
military installations (observations) within United States.
The data file was wrangled using the dyplr pipe function to select
for two columns, 'FULLNAME' and 'geometry' and then filter by 'FULLNAME'
for each of the four installations. This resulted in five
...
The data was organized to narrowing data sets to date,
...
frames were created to filter for April to September. For
each military base, the daily maximum temperature and wet bulb globe
temperature values were plotted over time and a trend line was added. The
...
color level at corresponding temperature. The mutate
...
summer time series data to explore trends during the
...
days subsets. Red flag days were not considered an subset independent
...
restrictions or precautions during a Red flag day are also
...
of WBGT days, either increasing or decreasing. There is a slight anomaly during 
the years 2018 and 2019 showing a higher than average number of high
...
peak during 2016 where all four installations have experienced
an increased number of summer season high heat days. Howeever, this trend
is muted at Ft Leonard Wood, MO.

To determine if a correlation exists, "corrtest" was run on
the year and the number of WBGT days.
...
observations were available (one observation a
...
negative to positive values at all three. The fourth
...
Ft Leonard Wood's negative correlation had the strongest
statistical significance, with a p-value of 0.2, although this is still
much greater than the 0.05 p-value allowing a rejection of the
...
Red flag days. For example, over the ten year period, Ft
...
temperatures caused by global warming occur slowly. The ten
...
the correlations tests, resulting in the large confidence intervals. 
Confidence intervals all ranged by more than 1C and ranged from 
...
except Ft Leonard Wood experiencing higher than average number of Black or Red 
flag days. The year 2019 saw the greatest number of
high heat days at Ft Sill and Ft Benning, indicating
an unusually warm summer. Ft Leonard Wood data is
the most consistent, with a steady number of high heat days
between 2012-2016 and 2021-2022. The consistency in number
of high heat days at Ft Leonard Wood combined with a string
of four lower than average years likely caused the weak negative
correlation in number of high heat days and year.

## Question 2:

It is clear that Ft Benning, GA experienced the most high
...
Black flag conditions at 510. Ft Sill, OK had more of the
...
months of each year can be built into a quarterly or yearly training program. 
High heat days and military training planning is analogous 
to elementary school districts and snow days; a set number of days are 
programmed into the school year to account for days when snowstorms close 
school. It is only during a particularly bad winter that the number of snow days
...
Ft Sill, OK and Ft Jackson, SC, sharing the #2 rank was
...
same climate subdivision, "Cfa" or Humid Subtropical, and are roughly
the same latitude. This appears to explain the similarity in the number
of high heat days.

From a heat injury risk standpoint, Ft Benning is the basic
training installation at greatest risk of high heat days. Soldiers at Ft
Benning should be expected to be at higher risk of heat related injury,
...
temperature days compare between training installations. 
Ft Benning, GA had the greatest number of high temperature days, 
while Ft Sill and Ft Jackson had a similar number. 
Understanding the historical number of days Red
and Black flag can help planners determine the number of extra days
need for a summer training cycle or the additional activity based
heat risk.

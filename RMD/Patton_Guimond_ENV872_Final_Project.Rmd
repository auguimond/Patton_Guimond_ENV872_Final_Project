...
```{r TEMP WORKSPACE DETELE IN FINAL --- ONLY DONE TO CREATE CLEAN VARIABLES FOR MAKING CELCIUS AND COUNTING FLAG DAYS IN SUBSEQUENT CODE FOR QUESTIONS 1B AND 2}
...
## Question 2: In terms of real number of days exceeding the Black or Red flag thresholds it is clear that Ft Benning, GA experienced the most high WBGT days. In total, there were 772 days at FBGA that were > 88F. Ft Sill, OK, and Ft Jackson, SC tied with a combined total of 510 Black or Red flag days, and Ft Leonard Wood, MO had the least amount of high heat training days, at 230. 

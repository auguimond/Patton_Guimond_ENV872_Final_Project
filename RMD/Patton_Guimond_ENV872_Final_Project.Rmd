...
R_B_subset_plot2 <- ggplot(R_B_subset2,aes(x=year))+
  geom_point(aes(y=FLW_Count_Days_Red_and_Above))+
  geom_line(aes(y=FLW_Count_Days_Red_and_Above))+
  geom_smooth(aes(y=FLW_Count_Days_Red_and_Above))+
  geom_point(aes(y=FBGA_Count_Days_Red_and_Above),color='blue')+
  geom_line(aes(y=FBGA_Count_Days_Red_and_Above),color='blue')+
  geom_smooth(aes(y=FBGA_Count_Days_Red_and_Above))
R_B_subset_plot2
```
